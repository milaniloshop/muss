...
export const PRODUCTS: Product[] = [
  live({
    id: 'corteiz-track-jacket',
    brand: 'Corteiz',
    title: 'Corteiz Track Jacket',
    shortDescription: 'Corteiz black track jacket with red/blue sleeve stripes. Size S. $100.',
    description:
      'Corteiz black full-zip track jacket with chest C-star mark, Corteiz back script, and red/blue sleeve stripes. Size S. Price $100.',
    price: 100,
    badge: 'S',
    tierRank: 0,
    fit: 'Size S only',
    fabric: 'Heavy knit / fleece track',
    sizes: ['S'],
    images: [
      '/assets/images/products/corteiz-track-jacket.jpg',
      '/assets/images/products/corteiz-track-jacket-2.jpg',
    ],
    imageLabels: ['Back', 'Front'],
    benefits: ['Corteiz branding', 'Red/blue sleeve stripes', 'Size S · $100'],
    details: { Size: 'S', Price: '$100' },
    styleIt: 'Black pants, clean sneakers. Corteiz energy.',
    faqs: [{ q: 'What size?', a: 'Size S only.' }],
    highlights: [
      { icon: '◆', title: 'Corteiz', desc: 'Track jacket' },
      { icon: '◆', title: 'S', desc: 'One size' },
      { icon: '◆', title: 'Stripes', desc: 'Red / blue' },
      { icon: '◆', title: '$100', desc: 'Listed price' },
    ],
    pros: ['Front + back photos', 'Clear Corteiz identity'],
    cons: ['Size S only'],
    expertVerdict: 'Corteiz track in S at $100 — compact street heat.',
  }),
  live({
    id: 'offwhite-ac-milan-varsity',
    brand: 'Off-White × AC Milan',
    title: 'Off-White × AC Milan Varsity Jacket',
    shortDescription: 'Off-White × AC Milan black varsity with devil graphics. Size M. $180.',
    description:
      'Off-White × AC Milan varsity jacket — black body, grey sleeves, Off-White Milan chest script, devil patches, diagonals, and OW back graphic. Size M. Price $180.',
    price: 180,
    badge: 'M',
    tierRank: 1,
    fit: 'Size M only',
    fabric: 'Varsity wool/felt body · leather-look sleeves',
    sizes: ['M'],
    images: [
      '/assets/images/products/offwhite-ac-milan-varsity.jpg',
      '/assets/images/products/offwhite-ac-milan-varsity-2.jpg',
      '/assets/images/products/offwhite-ac-milan-varsity-3.jpg',
      '/assets/images/products/offwhite-ac-milan-varsity-4.jpg',
    ],
    imageLabels: ['Front', 'Back', 'Sleeve detail', 'Back graphic'],
    benefits: ['Off-White × AC Milan collab', 'Devil / OW graphics', 'Size M · $180'],
    details: { Size: 'M', Price: '$180' },
    styleIt: 'Black jeans, white sneakers. Milan heat.',
    faqs: [{ q: 'What size?', a: 'Size M only.' }],
    highlights: [
      { icon: '◆', title: 'Off-White', desc: '× AC Milan' },
      { icon: '◆', title: 'Varsity', desc: 'Devil graphics' },
      { icon: '◆', title: 'M', desc: 'One size' },
      { icon: '◆', title: '$180', desc: 'Listed price' },
    ],
    pros: ['Full front/back/detail gallery', 'Matches MH black-red energy'],
    cons: ['Size M only'],
    expertVerdict: 'Off-White AC Milan varsity in M at $180 — on-brand Milan Hype piece.',
  }),
  live({
    id: 'new-era-knicks-champions',
    brand: 'New Era',
    title: 'New Era Knicks NBA Champions Snapback',
    shortDescription: 'New Era New York Knicks NBA Champions snapback. $60.',
    description:
      'New Era white/black snapback with New York Knicks NBA Champions front patch, gold brim stitch, and Larry O’Brien trophy side embroidery. Price $60.',
    price: 60,
    badge: 'Hat',
    tierRank: 2,
    fit: 'Adjustable snapback',
    fabric: 'Structured snapback',
    sizes: ['OS'],
    images: ['/assets/images/products/new-era-knicks-champions.jpg'],
    imageLabels: ['Front'],
    benefits: ['Knicks Champions patch', 'New Era snapback', '$60'],
    details: { Size: 'One size / adjustable', Price: '$60' },
    styleIt: 'Casual fits, black tee, denim.',
    faqs: [{ q: 'What size?', a: 'One size — adjustable snapback.' }],
    highlights: [
      { icon: '◆', title: 'New Era', desc: 'Snapback' },
      { icon: '◆', title: 'Knicks', desc: 'Champions patch' },
      { icon: '◆', title: 'OS', desc: 'Adjustable' },
      { icon: '◆', title: '$60', desc: 'Listed price' },
    ],
    pros: ['Clear front branding', 'Accessible price'],
    cons: ['One size', 'Single gallery photo'],
    expertVerdict: 'Knicks Champions New Era at $60 — easy accessory add-on.',
  }),
  live({
    id: 'bape-faze-hoodie',
  ...
  live({
    ...
    images: [
      ...
      '/assets/images/products/jordan-4-olive-4.jpg',
    ],
    imageLabels: ['Lateral', 'Medial', 'Heel pair', 'Heel pair alt'],
  ...
  live({
    ...
    sizes: ['10'],
    images: [
      '/assets/images/products/margiela-paint-drop.jpg',
      '/assets/images/products/margiela-paint-drop-2.jpg',
      '/assets/images/products/margiela-paint-drop-3.jpg',
      '/assets/images/products/margiela-paint-drop-4.jpg',
    ],
    imageLabels: ['Angle', 'Top / tongue', 'Angle alt', 'Pair top-down'],
